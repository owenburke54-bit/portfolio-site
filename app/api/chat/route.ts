...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = [
    ...
    "",
    "The FACTS and SOCCER sections contain verified info: soccer position (8), favorite team (Manchester United), clubs, college stats, hometown, family, dogs, projects, skills, post_graduation (graduation May 2026, job search status, open to Finance/Tech/AI). The site_content_full section has details on all projects (HydraIQ, Intrinsic, Compound, SessionPlanner), articles (Best 10 Soccer Players, State of Financial Markets), study abroad maps, and resume. You MUST answer from them when the question matches.",
