  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-2">
        ...
        />
        <p className="text-sm text-gray-500">Senior - Finance - Stonehill College</p>
      </section>
        ...
        <div className="grid gap-6 sm:grid-cols-5">
          ...
          <div className="sm:col-span-3 space-y-3">
            <div>
              ...
              <p className="text-gray-600">Jersey Number: #8</p>
            </div>
            ...
            <table className="min-w-[900px] w-full border-collapse">
              <thead className="bg-gray-50">
                <tr className="text-left">
                  ...
                  <th className="px-4 py-3 border-b border-gray-200 text-right">GP</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">GS</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">G</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">A</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">PTS</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">SH</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">SH%</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">SOG</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">SOG%</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">GW</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">PK-ATT</th>
                  <th className="px-4 py-3 border-b border-gray-200 text-right">MIN</th>
                </tr>
              </thead>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <span className="ml-4 text-xs text-gray-500">Sep 2, 2025</span>
            </div>
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <span className="ml-4 text-xs text-gray-500">Nov 12, 2025</span>
            </div>
            <p className="mt-2 text-gray-700">
      ...
      <section className="card p-6 space-y-3">
        ...
        <div className="w-full overflow-hidden rounded-xl border bg-gray-50">
          <div className="relative w-full" style={{ paddingTop: "56.25%" }}>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
              <p className="text-gray-700">Highlight video coming soon</p>
